                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane show active" id="custom-styles-preview">
                            <form class="needs-validation" id="CourseForm" method="POST" action="{{ route('lms.store.course') }}" enctype="multipart/form-data"  novalidate>
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="course_end_months" class="form-label">Course Duration (in Months)</label>
                                            <input type="number" class="form-control" id="course_end_date" name="course_end_months" placeholder="Enter in months" min="1" required>
                                        </div>
            ...
            $('#CourseForm').submit(function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#CourseForm')[0].reset();
                        setTimeout(() => {
                                    window.location.href = "{{ route('lms.courses') }}";
                                }, 1500);
                            },
                    error: function (xhr) {
                        if (xhr.status === 422) {
