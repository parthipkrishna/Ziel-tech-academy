    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="ExamForm" method="POST" action="{{ route('lms.exams.store') }}">
                    @csrf
                    <div class="row">
...
<script>
    $(document).ready(function () {
        $('#ExamForm').submit(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('lms.exams.store') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
                success: function (response) {
                    $('#modal-success-message').text(response.message ?? 'Exam created successfully!');
