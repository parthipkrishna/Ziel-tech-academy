...
<div class="container">
    ...
    <div id="add-question-form-container" class="card mt-4 d-none">
        <div class="card-body">
            ...
            <form action="{{ route('lms.assessment.storeQuestion', $exam->id) }}" id="AssessmentQuestionForm" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body p-4">
                                        <div class="text-center">
                                            ...
                                            <form action="{{ route('lms.assessment.deleteQuestion', $question->id) }}" method="POST">
                                                @csrf
...
<script>
    ...
    $('#EditQuestionForm').attr('action', '{{ route("lms.assessment.updateQuestion", ":id") }}'.replace(':id', questionId));
