    ...
    <div class="container-fluid">
        @if ($exams->isEmpty())
            <div class="alert alert-info text-center shadow-sm rounded">
                <h4><i class="bi bi-info-circle"></i> No Assessments Available</h4>
                <p>You have completed all available assessments or no assessments are assigned.</p>
            </div>
        @else
            <h3 class="text-center mb-5 fw-bold text-primary">📚 Available Assessments</h3>
            <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm border-0 hover-shadow transition">
                            <div class="card-body">
                                ...
                                @else
                                    <a href="{{ route('student.assessment.show', $exam['id']) }}" class="btn btn-outline-success w-100 fw-bold">
